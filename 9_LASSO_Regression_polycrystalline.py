...
lasso_model = LassoCV(cv=20, random_state=42).fit(X_train, y_train)
...
Z_grid = lasso_model.predict(grid_points).reshape(X_grid.shape)
...
print("All plots and GIF saved in 'LASSO_scaled_model' directory.")
